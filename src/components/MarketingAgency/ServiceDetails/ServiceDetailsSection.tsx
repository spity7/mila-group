import { IServiceDetails } from "@/constant/MarketingAgency/service-details/service-details-data";
        ...
        <div className="container">
          <div className="section-content">
            ...
            {serviceDetailsData?.content?.paragraphs?.length > 0 &&
              serviceDetailsData?.content.paragraphs.map((para: string, idx: number) => (

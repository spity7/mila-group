...
import {IChooseUs,IFeature} from '@/constant/MarketingAgency/common/choose-us';
      ...
      <div className="container">
        <div className={chooseUSTwo ? 'choose-area-2-inner section-spacing' : 'choose-area-inner section-spacing-top'}>
          <div className="section-content-wrapper">
            <div className="choose-thumb fade-anim" data-direction="left" suppressHydrationWarning={true}>

...
import { IServiceData } from "@/constant/DesignAgency/service-details/service-section-data";
  ...
  return (
    <section className="service-area-6">
      <div className="container">
        <div className={`service-area-6-inner ${type === "v2"?"section-spacing":"section-spacing-top"}`}>
